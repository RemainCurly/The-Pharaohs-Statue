...
//Borrowed from Gordon's material
public class Utils
{	public Utils() {}
    ...
    {	GL4 gl = (GL4) GLContext.getCurrentGL();
        ...
        byte[] topRGBA = getRGBAPixelData(topImage, false);     //parameter false means "don't flip the textures vertically"
        ...
        //Read in textures and covert them to Bytebuffers
        ...
        gl.glTexStorage2D(GL_TEXTURE_CUBE_MAP, 1, GL_RGBA8, 1024, 1024); //IMAGE DIMENSIONS MUST BE SPECIFIED! (1024x1024 here)

        //Assign each texture to a cube face
