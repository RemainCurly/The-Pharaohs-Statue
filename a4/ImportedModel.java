...
public class ImportedModel
{
    ...
    {	ModelImporter modelImporter = new ModelImporter(); //Usage of ModelImporter class
        try
        {	modelImporter.parseOBJ(filename);   //Get .obj
            numVertices   = modelImporter.getNumVertices();    //Get v, vt, vn lines from .obj file
    ...
    private class ModelImporter //NESTED CLASS: Model Importer =============
